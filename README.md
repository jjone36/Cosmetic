...
* **Applied skills:** Web scraping with selenium. Text manipulation and tokenization of NLP. Dimension reduction with SVD for getting the cosine similarity of chemical composition. Visualization with Bokeh library
